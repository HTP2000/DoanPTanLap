export async function onRequestPost(context) {
    ...
    try {
        ...
        try {
            ...
            console.log("Cảnh báo: Không kéo được tài liệu nội bộ.");
        }
...
2. Dựa vào [DỮ LIỆU ĐỊA PHƯƠNG] để phân loại cơ quan:
   - Thủ tục hành chính (Công chứng, khai sinh...): Chỉ đến UBND Phường.
   - Báo án, an ninh, hộ khẩu, CCCD: Chỉ đến CÔNG AN Phường.
3. Không tự bịa thông tin. Nếu không có dữ liệu, hãy mời người dân gọi hotline Đoàn phường.

HƯỚNG DẪN TẠO NÚT CHỈ ĐƯỜNG MÀU XANH:
Khi câu trả lời của bạn có nhắc đến một địa điểm và trong [DỮ LIỆU ĐỊA PHƯƠNG] có đoạn "Link bản đồ: http...", bạn BẮT BUỘC phải tạo ra một NÚT BẤM chỉ đường bằng cách chèn ĐÚNG đoạn HTML sau vào DƯỚI CÙNG câu trả lời của bạn:
